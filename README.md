...
```json
"depencies": {
  "@whiskeysockets/baileys": "github:BalzzXx/bail"
}
```
## Import
```javascript
...
await client.relayMessage(m.chat, {
  productMessage {
    ...
    url: "https://t.me/Balzzxwiwenk",
    body: "Nak Tido",
    footer: "Footer",
    buttons: [
      {
        name: "cta_url",
        buttonParamsJson: "{\"display_text\":\"balzzx\",\"url\":\"https://t.me/kayzennotdev\"}"
      }
    ],
